...
// -----------------------------------------------------------------------------
   ...
   private SlipnetNode fromNode, toNode;
...
// -----------------------------------------------------------------------------
   ...
   protected Link(String name, int intrinsicLength,
...
// -----------------------------------------------------------------------------
    ...
    * link.
    * 
    * All links have an intrinsic length, which can change for SlipLink objects.
    *
